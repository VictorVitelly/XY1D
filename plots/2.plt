...
set multiplot layout 4,1 title "T=0.2, L=50" font ',20'
    set ylabel 'E/L' font ',20' offset -5, 0 rotate by 0
    plot '../data/ThC.dat' u 4:5 w lines title 'Cluster'
    plot '../data/ThM.dat' u 4:5 w lines title 'Metropolis'
    set yrange[-4:4]
    set ylabel 'Q' font ',20' offset -2, 0 rotate by 0
